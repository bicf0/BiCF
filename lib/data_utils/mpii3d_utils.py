        ...
        for seq_i in seq_list:
            ...
            for j, vid_i in enumerate(vid_list):
                ...
                for i, img_i in tqdm_enumerate(img_list):
                    ...
                    joints_2d = convert_kps(joints_2d_raw, "mpi_inf_3dhp",  "spin").reshape((-1,3))   # (49, 3)
                    ...
                    joints_3d = convert_kps(joints_3d_raw, "mpi_inf_3dhp", "spin").reshape((-1,3))    # (49, 3)
...
if __name__ == '__main__':
    ...
    joblib.dump(dataset, osp.join(BLVF_DATA_DIR, 'mpi_inf_3dhp_val_db.pt'))

    dataset = read_data_train(args.dir)
    joblib.dump(dataset, osp.join(BLVF_DATA_DIR, 'mpi_inf_3dhp_train_db.pt'))
